...
(function(){
  ...
  function renderWebHistoryPage(){
    ...
    const entries = [
      {v:'2.4.3', title:'Open Graph para compartir enlace', items:['Se añade assets/preview-specialized-classes.png como imagen de previsualización del enlace.', 'Se añaden metaetiquetas og:* y twitter:* en index, clase, rasgos, mecánicas e histórico.', 'No cambia ningún dato del mod; solo cambia cómo se ve el enlace al compartir la web.']},
